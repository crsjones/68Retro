...
;
; PATCHED FOR HI-RES MOD BY CRAIG JONES MAY 2023
; ACCORDING TO " 'HI-RES' DISPLAY MOD. M.J. BAUER "
; PATCHES ARE TAGGED WITH (HI-RES)
;
;
...
;
DISBUF	EQU		$4000		; DISPLAY BUFFER AREA (HI-RES)
ENDBUF	EQU		$4400       ; (HI-RES)
...
ERASE:  CLRA                ; WRITE ZEROS TO SCREEN
        LDX 	#DISBUF     ; POINT TO DISPLAY BUFF (HI-RES)
FILL:   STAA 	0,X         ; FILL SCREEN WITH ACC-A
        INX 
        CPX  	#ENDBUF    	; DONE? (HI-RES)
        BNE     FILL
        RTS
...
;
; CHIPOS PATCHES FOR (HI-RES)
;
        ANDB    #$0F                     ;C226: C4 0F
        BNE     SHOW2                    ;C228: 26 02
        LDAB    #16                      ;C22A: C6 10
SHOW2:  PSHB                             ;C22C: 37
        STX     ZHI                      ;C22D: DF 14
        LDAA    0,X                      ;C22F: A6 00
        STAA    PATNH                    ;C231: 97 1E
        CLR     PATNL                    ;C233: 7F 00 1F
        LDAB    VX                       ;C236: D6 2E
        ANDB    #7                       ;C238: C4 07
SHOW3:  BEQ     SHOW4                    ;C23A: 27 09
        LSR     PATNH                    ;C23C: 74 00 1E
        ROR     PATNL                    ;C23F: 76 00 1F
        DECB                             ;C242: 5A
        BNE     SHOW3                    ;C243: 26 F5
SHOW4   LDAB    VX                       ;C245: D6 2E
        BSR     DISLOC                   ;C247: 8D 28
        LDAA    PATNH                    ;C249: 96 1E
        BSR     SHOWUP                   ;C24B: 8D 15
        LDAB    VX                       ;C24D: D6 2E
        ADDB    #8                       ;C24F: CB 08
        BSR     DISLOC                   ;C251: 8D 1E
        LDAA    PATNL                    ;C253: 96 1F
        BSR     SHOWUP                   ;C255: 8D 0B
        INC     VY                       ;C257: 7C 00 2F
        LDX     ZHI                      ;C25A: DE 14
        INX                              ;C25C: 08
        PULB                             ;C25D: 33
        DECB                             ;C25E: 5A
        BNE     SHOW2                    ;C25F: 26 CB
        RTS                              ;C261: 39
SHOWUP: TAB                              ;C262: 16
        EORB    0,X                      ;C263: E8 00
        ORAA    0,X                      ;C265: AA 00
        STAB    0,X                      ;C267: E7 00
        CBA                              ;C269: 11
        BEQ     SHOWR                    ;C26A: 27 04
        LDAA    #1                       ;C26C: 86 01
        STAA    VF                       ;C26E: 97 3F
SHOWR:  RTS                              ;C270: 39
DISLOC: LDAA    VY                       ;C271: 96 2F
        ANDA    #$3F                     ;C273: 84 3F
        ASLB                             ;C275: 58
        LSRA                             ;C276: 44
        RORB                             ;C277: 56
        ...
        RORB                             ;C27D: 56
        ORAA    #$40                     ;C27E: 8A 40
        STAA    BLOC                     ;C280: 97 1C
        STAB    BLOC+1                   ;C282: D7 1D
        LDX     BLOC                     ;C284: DE 1C
        RTS                              ;C286: 39
;
; KEYPAD ROUTINES 
...
SHOADR: LDAA    #$10        ; SET CURSOR HOME POSITION
        BSR     CURS1
        LDX     #DISBUF+912	; ILLUMINATE LAST 7 ROWS (HI-RES)
        LDAA  	#$FF
        JSR     FILL
