...
EDUMP PSHS X ;PUSH LOWER ADDR LIMIT ON STACK
 ...
 LBSR OUT2S     ;PRINT 2 SPACES - ADDED CJ
...
NOTHEX ORCC  #02       ;SET (V) FLAG IN C-CODES REGISTER
       RTS
...
RAMVEC FDB RTI    ;USER-V     WAS SWIE CJ
       FDB RTI    ;SWI3-V
       FDB RTI    ;SWI2-V
       FDB RTI    ;FIRQ-V
       FDB RTI    ;IRQ-V
...
MSG1 FCB $00,$00,$00,$0D,$0A,$00,$00,$00 ;* 0, CR/LF, 0
 FCC "S-BUG 1.8 - "
 FCB 4
